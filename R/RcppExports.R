...
buildAdaptiveACTIONet <- function(H_stacked, LC = 1, epsilon = 0, thread_no = 8L, auto_adjust_LC = FALSE, sym_method = "OR") {
...
reconstructArchetypes <- function(S, C_trace, H_trace, z_threshold = 1) {
...
batchPR <- function(G, U, alpha = 0.85, thread_no = 8L, tol = 1e-06) {
    .Call(`_ACTIONet_batchPR`, G, U, alpha, thread_no, tol)
}

zoned_diffusion <- function(G, zones, U, alpha = 0.85, thread_no = 8L, tol = 1e-06) {
...
signed_cluster <- function(A, resolution_parameter = 1, seed = 0L, initial_clusters_ = NULL) {
    .Call(`_ACTIONet_signed_cluster`, A, resolution_parameter, seed, initial_clusters_)
}

unsigned_cluster <- function(A, resolution_parameter = 1, seed = 0L, initial_clusters_ = NULL) {
